...
export function NaOH (props: SVGPropsType) {
  ...
  return (
    ...
    <img 
      ...
      className="chemical-icon object-contain" 
...
export function NaOH_4 (props: SVGPropsType) {

  return (

    <img 
      src="/images/icon/NaOH_3.png" 
      alt="Sodium Hydroxide (NaOH)"
      width={55} 
      height={58}
      // If you are using Tailwind or custom CSS
...
export function HCI_4(props: SVGPropsType) {

  return (

    <img 
      src="/images/icon/HCI_3.png" 
      alt="Hydrochloric Acid (HCl)"
      width={55} 
      height={58}
      // If you are using Tailwind or custom CSS
